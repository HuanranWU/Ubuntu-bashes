...
# This is adapted from an answer on https://askubuntu.com/questions/1126838/set-system-proxy-automatically-on-connecting-to-wifi-network-on-ubuntu-18-04-bio
# I use this script to change the proxy with a command in bash after change the setting of a proxy software
# two lines are added in .bashrc to make the flow fluent
# alias proxy='sudo /home/hrwu/bin/setproxy.sh 127.0.0.1 41091'
# alias unproxy='sudo /home/hrwu/bin/setproxy.sh'
